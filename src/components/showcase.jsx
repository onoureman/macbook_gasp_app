...
const Showcase = () => {
  ...
  useEffect(() => {
    if (!sectionRef.current || isTablet) return;
  ...
  return (
    <section id="showcase" ref={sectionRef}>
      ...
      <div className="content opacity-0 translate-y-5">
          ...
          <div className="lg:max-w-md">
            ...
            <div className="space-y-5 mt-7 pe-10">
              ...
              <p>
                ...
                and brightness. And a next-gen GPU with hardware-accelerated ray tracing
